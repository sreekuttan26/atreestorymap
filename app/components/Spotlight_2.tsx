    ...
    return (
        <div className="relative w-full h-full flex flex-col items-start  justify-start ">
            ...
            <div
                ...
                ref={imgRef}
                className={`absolute top-0 left-0 w-full h-full  items-center justify-start z-10 ${currentspot === images[0] ? "flex" : "flex"}`}
            ...
            <div className="relative z-20 flex flex-col gap-20 pt-40 items-end px-20 w-full ">
                ...
                <div className="bg-white p-4 w-[500px] rounded-xl opacity-90 border-2 border-gray-200 ">
                    ...
                    <h1 className="text-lg font-semibold mt-3">Elected Government Representatives</h1>

                    <div className='w-full flex flex-col gap-5'>
                        <p>The on-ground efforts of the researchers have served as an inspiration, generating data and momentum that effectively rekindled both local and institutional interest in the lake’s restoration. Krishna Byre Gowda, a prominent figure from the Congress Party and the State Revenue Minister, who was elected a Member of the Legislative Assembly from Byatarayanapura Constituency encompassing Venkateshpura Lake, publicly aligned himself with the restoration initiative. This strategic move proved pivotal in galvanising all-rounded support for the lake’s revival.</p>

                        <p>Gowda embraced the lake project as a flagship initiative during his election campaign, and following his electoral victory, he took decisive steps to reignite the momentum for restoration efforts. The active involvement of his spouse,…, in the project became a leverage for change.</p>

                        <p>His social media posts concerning the rejuvenation efforts garnered critical public attention necessary to highlight both the lake’s importance and the challenges it faced.</p>
